...
from local_dev_proxy.generator import choose_port, rank_services
...
def test_generate_writes_an_override(monkeypatch) -> None:
    monkeypatch.setattr(
        "local_dev_proxy.cli.resolve_compose", lambda files: compose_model()
    )
    runner = CliRunner()
    ...
    with runner.isolated_filesystem():
        ...
        assert "local-dev-proxy:" in override
